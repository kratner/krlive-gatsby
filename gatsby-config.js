  ...
  plugins: [
    ...
    // Simple config, passing URL
    {
      ...
      options: {
        ...
        fieldName: "swapi",
        // Url to query from
        url: "https://keithratner.live/graphql",
      },
    },
    */
    /*
    {
      ...
      options: {
        url:
          ...
          process.env.WPGRAPHQL_URL || `https://keithratner.live/graphql`,
        schema: {
    ...
    */
     ...
     */
    {
      ...
      options: {
         ...
         */
        baseUrl: "keithratner.live",
        // The protocol. This can be http or https.
        protocol: "https",
        // The rest api route   that your WordPress site is using.
        // Sometimes this is modified by WordPress plugins.
        // If not set, it uses the default of "wp-json"
        /* restApiRoutePrefix: "wp-json", */
        restApiRoutePrefix: "graphql",
        ...
        */
        url: process.env.WPGRAPHQL_URL || `https://keithratner.live/graphql`,
      },
    },
    {
